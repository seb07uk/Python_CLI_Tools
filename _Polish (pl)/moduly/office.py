...
def office_viewer(*args):
    """Główny moduł biurowy systemu TERMINAL CLI."""
    ...
    # 1. Przykład czytania notatek (zgodnie z Twoim schematem)
    ...
    # 3. Listowanie innych plików biurowych wtyczek
